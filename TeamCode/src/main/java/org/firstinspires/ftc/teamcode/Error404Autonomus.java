...
//                    state = 67;
            ...
            //fail-safe step 2:
            //   extend hook for one second or 350 encoders -- will extend the hanger .25 inch --
            //   then reset to case 0 and reattempt detaching from lander
            case 67:
                if(robot.hangDrive(.9, 350, Gen2_Hang.HangDirection.OUT) || getRuntime() > 1.25)
                {
                    resetStartTime();
                    fail++;
                    state = 73;
